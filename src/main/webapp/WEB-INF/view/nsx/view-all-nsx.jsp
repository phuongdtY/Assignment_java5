...
<main>
    <div class="container">
        ...
        <section>
            <form:form action="/nsx/add" method="post" modelAttribute="nsx" cssClass="px-5">
            ...
            <table class="table">
                ...
                <c:forEach items="${listNsx.content}" var="nsx" varStatus="stt">
                    <tr>
                        ...
                        <td>${nsx.ten}</td>
                        <td>
                            <a href="/nsx/detail/${nsx.id}" class="btn btn-warning">Detail</a>
                            <a href="/nsx/view-update/${nsx.id}" class="btn btn-success">Update</a>
                            <a href="/nsx/remove/${nsx.id}" class="btn btn-danger">Remove</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                    <li class="page-item ${pageNo <= 0 ? 'disabled':''}">
                        <a class="page-link" href="/nsx/view-all?page=${ pageNo - 1}">Previous</a>
                    </li>

                    <c:forEach begin="0" end="${listNsx.totalPages - 1}" varStatus="loop">
                        <li class="page-item"><a class="page-link"
                                                 href="/nsx/view-all?page=${loop.begin + loop.count - 1}">
                                ${loop.begin + loop.count}
                        </a></li>
                    </c:forEach>

                    <li class="page-item page-item ${pageNo >= listNsx.totalPages - 1 ? 'disabled':''}">
                        <a class="page-link" href="/nsx/view-all?page=${ pageNo + 1}">Next</a>
                    </li>
                </ul>
            </nav>
        </section>
