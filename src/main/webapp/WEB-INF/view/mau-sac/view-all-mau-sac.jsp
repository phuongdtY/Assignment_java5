...
<main>
    <div class="container">
        ...
        <section>
            <form:form action="/mau-sac/add" method="post" modelAttribute="ms" cssClass="px-5">
        ...
        <section>
            <table class="table">
                ...
                <tbody>
                <c:forEach items="${listMauSac.content}" var="ms" varStatus="stt">
                    <tr>
                        <td>${stt.index + 1}</td>
                        <td>${ms.ma}</td>
                        <td>${ms.ten}</td>
                        <td>
                            ...
                            <a href="/mau-sac/remove/${ms.id}" class="btn btn-danger">Remove</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                    <li class="page-item ${pageNo <= 0 ? 'disabled':''}">
                        <a class="page-link" href="/mau-sac/view-all?page=${ pageNo - 1}">Previous</a>
                    </li>

                    <c:forEach begin="0" end="${listMauSac.totalPages - 1}" varStatus="loop">
                        <li class="page-item"><a class="page-link"
                                                 href="/mau-sac/view-all?page=${loop.begin + loop.count - 1}">
                                ${loop.begin + loop.count}
                        </a></li>
                    </c:forEach>

                    <li class="page-item page-item ${pageNo >= listMauSac.totalPages - 1 ? 'disabled':''}">
                        <a class="page-link" href="/mau-sac/view-all?page=${ pageNo + 1}">Next</a>
                    </li>
                </ul>
            </nav>
        </section>
